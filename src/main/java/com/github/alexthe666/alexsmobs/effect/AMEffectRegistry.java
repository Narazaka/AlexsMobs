...
public class AMEffectRegistry {
    ...
    public static void init(){
        ...
        BrewingRecipeRegistry.addRecipe(Ingredient.of(AMItemRegistry.LAVA_BOTTLE.get()), Ingredient.of(AMItemRegistry.COCKROACH_WING.get()), createPotion(LONG_BUG_PHEROMONES_POTION));
        ...
        BrewingRecipeRegistry.addRecipe(Ingredient.of(AMItemRegistry.LAVA_BOTTLE.get()), Ingredient.of(AMItemRegistry.SOUL_HEART.get()), createPotion(LONG_SOULSTEAL_POTION));
        ...
        BrewingRecipeRegistry.addRecipe(Ingredient.of(AMItemRegistry.LAVA_BOTTLE.get()), Ingredient.of(AMItemRegistry.DROPBEAR_CLAW.get()), createPotion(LONG_CLINGING_POTION));
